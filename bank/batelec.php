...
$userBalance = ($user) ? $user['balance'] : "N/A"; 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($userBalance >= $paymentAmount) {
        ...
        try {
            ...
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('joelapuk11@gmail.com', 'Canes'); // Replace with your name and email address
            $mail->addAddress($userEmail);
            $mail->Subject = "Payment Received";
            $mail->Body = "Thank you for your payment of $paymentAmount. We have received your payment.";
            $mail->send();
